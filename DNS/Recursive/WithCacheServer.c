...
#include <arpa/inet.h>
#include <errno.h>
#define ROOTPORT 7272
//#define TLDPORT 7274      //THE TLD AND AUTH ARE TO BE RECEIVED FROM ROOT AND TLD SERVERS RESPECTIVELY
//#define AUTHPORT 7275      //BUT WE HARD CODE AS THIS IS A SIMULATION ONLY FOR UNDERSTANDING PURPOSES.
#define LOCALPORT 7273
